...
Or you can use it to mirror another menu by using the `sidebar_menu.mirror` option in your [Widgets 配置 File]({{< relref "/docs/widgets.md#widgets-配置-file" >}}). For example, this will mirror the Main Menu:
...
If you want to change the order of the social menu icons, use the `social_menu.platforms` option in your [Widgets 配置 File]({{< relref "/docs/widgets.md#widgets-配置-file" >}}).
